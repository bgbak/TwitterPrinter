...
class ThermalPrinter(object):
    ...
    def setcharset(self, charset):
        ...
        self.printer.write(chr(charset))
    ...
    def printtest2(self):
        ...
        self.justify('C')
        self.print_text("Center justified\n")
        self.justify('L')
        ...
        self.bold_off()
        self.underline_on()
        self.print_text("Underlined text\n")
        self.underline_off()

        self.upsidedown_on()
        self.print_text("Upside down text\n")
        self.upsidedown_off()
